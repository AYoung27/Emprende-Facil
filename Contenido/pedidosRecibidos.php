				...
				<div class="col-md-12" style="border-width: 1px 1px 1px 1px; border-style: solid; border-color: lightgray;">
							...
							<div class="container">								
								<ul class="nav justify-content-center">
								  <li class="nav-item">
								    <a class="nav-link " href="#pedidosHechos" onclick="cargarDiv('zonaContenido','Contenido/pedidos.php')">Hechos</a>
								  </li>
								  <li class="nav-item">
								    <a class="nav-link disabled" href="#pedidosRecibidos" aria-disabled="true">Recibidos</a>
								  </li>
								</ul>
							</div>
