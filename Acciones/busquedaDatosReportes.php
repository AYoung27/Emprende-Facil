...
/*function listarProductos($valor,$conexion){
   ...
   $sql="SELECT tbl_usuario.Nombre , tbl_factura.FechaFactura, tbl_producto.NombreProducto, tbl_detalle_factura.Cantidad, tbl_producto.PrecioActual, tbl_detalle_factura.Total  FROM tbl_factura  
   ...
   WHERE  tbl_proveedor.IDProveedor=".$_SESSION['Proveedor'];
   ...
   if(isset($_POST['consulta'])){
    ...
    INNER JOIN tbl_usuario on tbl_factura.IDUsuario = tbl_usuario.IDUsuario
    INNER JOIN tbl_proveedor on tbl_producto.IDProveedor=tbl_proveedor.IDProveedor
    WHERE tbl_proveedor.IDProveedor=".$_SESSION['Proveedor']." and (Nombre like '%".$_POST['consulta']."%' OR NombreProducto like '%".$_POST['consulta']."%')   ";
}
