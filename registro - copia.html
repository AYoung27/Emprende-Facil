...
<html>
		...
		<form class="form-signin">
  			<div class="text-center mb-4">
    			...
    			<h1 class="h3 mb-3 font-weight-normal">Registrate ya</h1>
    				<p>El registro es gratis, no necesitas tarjeta de credito para utilizar esta plataforma</p>
  			</div>
  ...
  <div class="checkbox mb-3">
    <label>
      <input type="checkbox" value="remember-me"> He leido los terminos y condiciones
    </label>
  </div>
